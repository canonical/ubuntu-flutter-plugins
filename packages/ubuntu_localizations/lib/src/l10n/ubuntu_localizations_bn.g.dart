...
class UbuntuLocalizationsBn extends UbuntuLocalizations {
  UbuntuLocalizationsBn([String locale = 'bn']) : super(locale);

  @override
  String get countryCode => 'BD';
  ...
  @override
  String get revertLabel => 'পূর্বাবস্থায় প্রত্যাবর্তন';
